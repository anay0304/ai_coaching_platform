...
- Name: demo-login.spec.ts >> Demo login flow (22.7) >> shortcut button logs in as demo user and redirects to /dashboard
- Location: e2e\demo-login.spec.ts:19:7
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e7]:
      ...
      - alert [ref=e11]: Demo login failed. Please try again.
      - generic [ref=e12]:
        - generic [ref=e13]:
